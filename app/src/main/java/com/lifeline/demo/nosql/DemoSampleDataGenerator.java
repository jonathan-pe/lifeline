...
public class DemoSampleDataGenerator {
    ...
    /* package */ static Double getRandomPartitionSampleNumber() {
        return (double) getRandomPartitionNumber() + SAMPLE_DATA_NUMBER_MIN;
    }
    ...
    /* package */ static Double getRandomSampleNumber() {
        return (double) SAMPLE_DATA_NUMBER_MIN + getRandomNumber();
    }
